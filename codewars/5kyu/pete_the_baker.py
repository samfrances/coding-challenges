...
"""
Solution to https://www.codewars.com/kata/525c65e51bf619685c000059/
...
(e.g. 1 lb of flour or 200 g of sugar are simply 1 or 200). Ingredients that are
...
def cakes(recipe, available):
    how_many = {
        ingredient: available.get(ingredient, 0) / recipe[ingredient]
        for ingredient in recipe
    }
    return min(how_many.values())
