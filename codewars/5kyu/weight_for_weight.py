...
"""
Solution to https://www.codewars.com/kata/55c6126177c9441a570000cc/
...
def order_weight(strng):
    num_strings = strng.split()
    num_strings_ordered = sorted(num_strings, key=_key)
    return " ".join(num_strings_ordered)


def _key(num_string):
    score = sum(int(ch) for ch in num_string)
    return (score, num_string)
